...
public class PartenaireModificationController {
	...
	private void modifier_les_informations_du_parteenaire_selectionne(ActionEvent actionEvent) throws NumberFormatException, ClassNotFoundException, SQLException {
		boolean verificationDeLaSyntaxeDeLEmail = User.verifier_la_syntaxe_de_l_email(emailInput.getText());
				...
				{	
					...
					{	
						...
						{	
							...
							{
								String roles = "[\"ROLE_PARTENAIRE\"]";
								User user = new User();
								user.setId(Integer.parseInt(idLabel.getText()));
								...
								boolean empdata = UserDAO.modifier(user);
								...
								if(empdata == true) 
								{
									...
									{
										boolean verificationEnvoiEmail = User.email_de_modification(emailInput.getText());
